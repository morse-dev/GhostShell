...
cls
echo ============================================================
echo               GhostShell Ethical Hacking Toolkit License - Version !version!
echo ============================================================
...
cls
echo ==================================================
echo             GHOSTSHELL TOOLKIT MENU - Version !version!
echo ==================================================
...
cls
echo =================== SETTINGS =====================
echo [1] Toggle Cloak Mode (Current: !CLOAK_MODE!)
echo [2] Back to Menu
echo ==================================================
